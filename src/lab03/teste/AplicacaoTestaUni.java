...
public class AplicacaoTestaUni {
    public static void main(String args[]) {
        ...
        final int NUM_ALUNOS_TURMA = 44; // ! O programa não rodara com esse numero de alunos, já que o limite de alunos
                                         // é 35. Mas testei diminuindo o limite e o programa rodou.
